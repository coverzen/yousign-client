...
class YousignFaker
{
    ...
    public function __construct()
    {
        ...
        Http::fake(
            static function (Request $request) use ($url): PromiseInterface|null {
                if ($request->url() === $url . Yousign::SIGNATURE_REQUESTS_BASE_URL . '/*' && $request->method() === HttpRequest::METHOD_DELETE) {
